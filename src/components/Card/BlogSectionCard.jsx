...
const BlogSection = ({ icon, heading, subheading, features }) => {
  ...
  return (
    <>
      {isDesktopOrLaptop && (
        <section className="flex background-primary text-white items-center justify-between border-primary">
      ...
      {isMobile && (
        <section className="px-4 flex flex-col background-primary text-white items-center justify-between border-primary">
