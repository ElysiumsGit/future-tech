...
function BlogContent({
  ...
  return (
    <section className="border-primary flex items-stretch justify-center">
      {/* Left Section */}
      <div className="flex flex-1 h-auto flex-col border-primary bg-black w-full gap-8 pl-40 py-20 pr-20 justify-center">
        ...
        <div className="flex p-4 border-primary rounded-lg bg-[#1A1A1A] items-center justify-between">
          ...
          <div className="flex -space-x-4 bg-black px-4 py-2 border-primary rounded-full ">
            {avatars.map((src, idx) => (
              <img
                key={idx}
      ...
      {/* Right Section */}
      <div className="flex flex-2 flex-col gap-6 border-primary bg-black w-full pl-20 py-20 pr-40">
